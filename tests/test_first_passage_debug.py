# Debug few sample paths to inspect Brownian Bridge masks
import math
import os
import sys
...
def debug_once(seed=42):
    ...
    for i in range(n_paths):
        ...
        for t in range(max_steps):
            ...
            pr = prev[i, t]
            nx = nxt[i, t]
            print(f' t={t+1:2d} price={p:8.4f} prev_log={pr:8.4f} next_log={nx:8.4f} prob_tp={prob_tp[i,t]:.6f} bridge_tp={bridge_tp[i,t]} price_hit_tp={prices[i,t]>=tp_level} bridge_hit_tp={bridge_tp[i,t]} hit_tp={hit_tp[i,t]}')
        print('---')
