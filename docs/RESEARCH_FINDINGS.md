...
> Auto-generated: 2026-02-18 08:02
...
**Best Finding:** volatility_gate: OOS-adjusted PnL +$269.52
- Improvement: $+269.52
- Confidence: 60%
...
예상 효과: PnL $+355.26 (OOS 보정 $+269.52), WR -0.6%, R:R +2.00
OOS 검증: pass=True rate=75% trainΔ=+104.40 testΔ=+79.21 penalty=0.76
신뢰도: 59.6%
```
...
|--------|----------|----|----|
| n | 4642 | 919 | -3723 |
| pnl | -368.57 | -13.31 | +355.26 |
| wr | 0.1932 | 0.1872 | -0.0060 |
| rr | 1.79 | 3.79 | +2.00 |
| edge | -0.1650 | -0.0214 | +0.1436 |
| sharpe | -6.52 | -0.35 | +6.17 |
| pf | 0.43 | 0.87 | +0.44 |
...
2. **volatility_gate: OOS-adjusted PnL +$269.52** (ΔPnL: $+269.52, confidence: 60%)
   - `scope` = `all_regimes`
   - `chop_min_sigma` = `0.1`
   - `chop_max_sigma` = `2.5`
   - `chop_max_vpin` = `0.65`
