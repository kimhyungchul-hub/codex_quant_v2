...
> Auto-generated: 2026-02-18 06:45
...
**Best Finding:** volatility_gate: OOS-adjusted PnL +$292.29
- Improvement: $+292.29
- Confidence: 67%
- Parameters: `{"scope": "chop_only", "chop_min_sigma": 0.1, "chop_max_sigma": 0.8, "chop_max_vpin": 0.65, "chop_min_dir_conf": 0.68, "chop_min_abs_mu_alpha": 40.0, "chop_max_hold_sec": 180}`
...
예상 효과: PnL $+336.07 (OOS 보정 $+292.29), WR +5.2%, R:R +0.59
OOS 검증: pass=True rate=75% trainΔ=+87.58 testΔ=+76.17 penalty=0.87
신뢰도: 66.6%
```
...
|--------|----------|----|----|
| n | 4970 | 1338 | -3632 |
| pnl | -390.23 | -54.15 | +336.07 |
| wr | 0.1883 | 0.2399 | +0.0516 |
| rr | 1.81 | 2.40 | +0.59 |
| edge | -0.1672 | -0.0540 | +0.1132 |
| sharpe | -6.88 | -1.18 | +5.71 |
| pf | 0.42 | 0.76 | +0.34 |
...
1. **volatility_gate: OOS-adjusted PnL +$292.29** (ΔPnL: $+292.29, confidence: 67%)
   - `scope` = `chop_only`
   - `chop_min_sigma` = `0.1`
   - `chop_max_sigma` = `0.8`
   - `chop_max_vpin` = `0.65`
...
2. **vpin_filter: OOS-adjusted PnL +$292.27** (ΔPnL: $+292.27, confidence: 65%)
   - `max_vpin` = `0.3`

3. **volatility_gate: OOS-adjusted PnL +$291.92** (ΔPnL: $+291.92, confidence: 67%)
   - `scope` = `chop_only`
   - `chop_min_sigma` = `0.5`
   - `chop_max_sigma` = `0.8`
   - `chop_max_vpin` = `0.65`
...
4. **regime_side_block: OOS-adjusted PnL +$262.40** (ΔPnL: $+262.40, confidence: 56%)
   - `regime_side_block_list` = `bear_long,bull_short,chop_long`

5. **chop_guard: OOS-adjusted PnL +$246.94** (ΔPnL: $+246.94, confidence: 56%)
   - `chop_entry_floor_add` = `0.005`
   - `chop_entry_min_dir_conf` = `0.8`
