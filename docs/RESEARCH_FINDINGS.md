...
> Auto-generated: 2026-02-18 09:20
...
**Best Finding:** volatility_gate: OOS-adjusted PnL +$275.29
- Improvement: $+275.29
- Confidence: 64%
- Parameters: `{"scope": "all_regimes", "chop_min_sigma": 0.2, "chop_max_sigma": 2.5, "chop_max_vpin": 0.65, "chop_min_dir_conf": 0.6, "chop_min_abs_mu_alpha": 10.0, "chop_max_hold_sec": 450}`
...
예상 효과: PnL $+349.53 (OOS 보정 $+275.29), WR +1.6%, R:R +1.39
OOS 검증: pass=True rate=75% trainΔ=+99.10 testΔ=+78.05 penalty=0.79
신뢰도: 63.9%
```
...
|--------|----------|----|----|
| n | 4642 | 932 | -3710 |
| pnl | -368.57 | -19.04 | +349.53 |
| wr | 0.1932 | 0.2092 | +0.0160 |
| rr | 1.79 | 3.18 | +1.39 |
| edge | -0.1650 | -0.0300 | +0.1350 |
| sharpe | -6.52 | -0.47 | +6.05 |
| pf | 0.43 | 0.84 | +0.41 |
...
2. **volatility_gate: OOS-adjusted PnL +$275.29** (ΔPnL: $+275.29, confidence: 64%)
   - `scope` = `all_regimes`
   - `chop_min_sigma` = `0.2`
   - `chop_max_sigma` = `2.5`
   - `chop_max_vpin` = `0.65`
...
3. **volatility_gate: OOS-adjusted PnL +$258.46** (ΔPnL: $+258.46, confidence: 60%)
   - `scope` = `all_regimes`
   - `chop_min_sigma` = `0.35`
   - `chop_max_sigma` = `1.2`
   - `chop_max_vpin` = `0.65`
