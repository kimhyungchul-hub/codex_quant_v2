...
> Auto-generated: 2026-02-18 08:04
...
**Best Finding:** volatility_gate: OOS-adjusted PnL +$247.62
- Improvement: $+247.62
- Confidence: 55%
- Parameters: `{"scope": "all_regimes", "chop_min_sigma": 0.1, "chop_max_sigma": 0.8, "chop_max_vpin": 0.65, "chop_min_dir_conf": 0.64, "chop_min_abs_mu_alpha": 0.0, "chop_max_hold_sec": 450}`
...
예상 효과: PnL $+350.34 (OOS 보정 $+247.62), WR +1.2%, R:R +1.05
OOS 검증: pass=True rate=75% trainΔ=+108.89 testΔ=+76.96 penalty=0.71
신뢰도: 55.3%
```
...
|--------|----------|----|----|
| n | 4970 | 1030 | -3940 |
| pnl | -390.23 | -39.88 | +350.34 |
| wr | 0.1883 | 0.2000 | +0.0117 |
| rr | 1.81 | 2.86 | +1.05 |
| edge | -0.1672 | -0.0590 | +0.1082 |
| sharpe | -6.88 | -1.00 | +5.88 |
| pf | 0.42 | 0.72 | +0.29 |
...
2. **regime_side_block: OOS-adjusted PnL +$262.40** (ΔPnL: $+262.40, confidence: 56%)
   - `regime_side_block_list` = `bear_long,bull_short,chop_long`

3. **volatility_gate: OOS-adjusted PnL +$247.62** (ΔPnL: $+247.62, confidence: 55%)
   - `scope` = `all_regimes`
   - `chop_min_sigma` = `0.1`
   - `chop_max_sigma` = `0.8`
   - `chop_max_vpin` = `0.65`
...
4. **volatility_gate: OOS-adjusted PnL +$247.58** (ΔPnL: $+247.58, confidence: 54%)
   - `scope` = `all_regimes`
   - `chop_min_sigma` = `0.35`
   - `chop_max_sigma` = `0.8`
   - `chop_max_vpin` = `0.65`
